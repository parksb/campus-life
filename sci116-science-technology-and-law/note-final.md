...
- 사용자 책임:
  ...
  - 사용자의 면책가능성이 있지만, 실제 판례의 태도는 사실상 사용자의 무과실 책임과 유사하게 운용.
- 동물점유자 책임규정:
...
- 특허권의 존속기간:
  ...
  - 특허권 존속기간의 연장:
    ...
    - 특히 의약품은 출원부터 임상시험, 제조, 판매까지 걸리는 시간이 오래 걸림.
- 특허 침해의 구제청구:
  - 침해금지 청구권:
    - 직접침해:
      ...
      - 침해 성립 요건:
        ...
        - 업으로 실시하는 행위가 있을 것.
      - 특허균등론: 침해 의심되는 발명이 청구항에 기재된 문언적 요소와 동일하지는 않지만, 핵심적인 원리와 사상이 동일하고, 실질적으로 동일한 기능을 수행해 동일한 효과를 가져오며, 기술의 치환이 기술분야의 통상인을 기준으로 용이한 경우 침해로 본다.
    - 간접침해:
      - 특허침해 행위를 돕는 경우 간접침해.
...
- 배포권 및 대여권:
  ...
  - > 저작권법 제21조(대여권) 제20조 단서에도 불구하고 저작자는 상업적 목적으로 공표된 음반(이하 "상업용 음반"이라 한다)이나 상업적 목적으로 공표된 프로그램을 영리를 목적으로 대여할 권리를 가진다. <개정 2009. 4. 22., 2016. 3. 22.>
  - 저작권에도 권리소진이론이 적용:
...
- 공중송신권:
  - > 저작권법 제18조(공중송신권) 저작자는 그의 저작물을 공중송신할 권리를 가진다.
...
- 2차 저작물 작성권:
  ...
  - 원저작물을 번역, 편곡, 각색, 영상제작 등의 방법으로 변형한 창작물.
  - 리메이크랑은 다름. 가사와 멜로디를 바꾸지 않고 그냥 새 가수가 부르는 건 2차 저작물이 아님.
  - 저작권법 시작한 뒤로 교수님이 매 수업마다 노래를 부름.
  - e.g., 유명가수가 70년대 유행가에 대한 복제, 공연, 공중전송권을 허락받고 리메이크. 근데 들어보니 노래가 너무 많이 바뀌어 있어서 저작권 침해로 손배청구. 이미 허락했는데 어떻게 사용하는지 문제삼을 수 있나?
    - 2차 저작을 허락받지 않고 편곡했기 때문에 저작권 침해가 성립.
    - 원작자는 원저작물을 똑같이 사용할 권리(복제권)와 이를 공연, 공중송신할 권리만을 허락한 것.
  - e.g., 만화를 영화로 제작하기 위한 라이선스 체결. 근데 영화 내용이 너무 각색되어 있어서 원작자가 상영금지 가처분신청. 영화사는 영상물로 만들기 위해 불가피하게 각색했다고 주장.
    - 영상저작물에 대해서는 특례가 있음. 영상화할 때 원저작물의 상당부분을 개작하는 것이 불가피하다는 점을 고려해, 구체적인 라이선스 계약에 포함되어 있지 않아도 영상화에 동의하는 경우 저작물을 각색할 수 있는 권리를 허락한 것으로 추정.
  - e.g., A 프로그램 개발자가 의뢰받은 B 프로그램을 개발. 이때 A 프로그램의 코드를 일부 수정해서 사용. 근데 클라이언트가 B 프로그램을 수정해서 판매. 개발자는 B 프로그램이 2차저작물이라고 주장.
    - 컴퓨터 프로그램에 대해서도 특례가 있다.
    - 프로그램 저작권을 양도할 때는 프로그램에 대한 2차저작물 작성권도 양도 대상에 포함되는 것으로 규정. 소프트웨어의 특성상 유지보수를 위해 빈번한 변경과 수정이 당연히 예상되기 때문.
- 온라인 서비스 제공자의 책임:
  - 온라인 서비스 제공자가 그 서비스 이용자가 저지른 저작권 침해행위에 대해 책임을 져야하나?
  - 다음과 같은 사유가 있다면 책임을 면제:
    - 서비스 제공자가 저작권 침해 사실을 알고 복제전송을 방지하거나 중단시킨 경우.
    - 복제전송을 방지하거나 중단시키려고 했으나, 기술적으로 불가능했던 경우.

#### 저작권 침해의 예외

- 저작권 침해했다고 어디 법무법인 도장찍혀서 내용증명 날아오면 무섭겠죠.
- 근데 대부분의 경우 저작권 침해의 예외에 해당하는 경우가 많음.
- 예외에 해당하는데 모르고 돈 줬으면 돈을 돌려받을 수 없음.
- 학교교육 목적 등에의 이용:
  - 고등학교 이하의 학교교육 목적상 필요한 교과용 도서에는 공표된 저작물을 게재할 수 있다.
    - 대학 교재는 교과용 도서라고 해도 저작물의 게재가 저작권 침해의 예외로 인정되지 않음.
    - 판례에 따르면 교과서 뿐 아니라, 고등학생들의 진학지도를 목적으로 하는 잡지도 인정해줌.
  - 유아교육, 초중등교육, 고등교육 등에서 수업목적으로 저작물을 사용하는 것도 예외로 인정.
    - 심지어 교육을 받는 자도 수업 목적상 필요하다고 인정되면 저작물을 복제, 이용 가능.
    - 단, 고등교육기관에서 저작물을 이용할 때는 저작권협회에 보상금을 지급해야 한다.
    - 아주대도 매년 저작권협회에 돈을 내고 있다.
- 사적 이용을 위한 복제:
  ...
  - e.g., 여자친구를 위해 음반을 mp3 파일로 추출해서 선물.
    - 복제해서 혼자 들었으면 사적 이용으로 인정되기 때문에 저작권 침해가 아님.
    - 친구가 산 음반을 전달받아서 mp3 파일로 추출하고 나 혼자 들었어도 사적 이용.
    - 근데 여자친구에게 줬으면 가정 및 이에 준하는 한정된 범위에서 이용한 것으로 볼 수 없음. 따라서 저작권 침해가 성립.
    - 단, 공중의 사용에 제공하기 위해 설치된 복사기기, 스캐너, 사진기 등 복제기기에 의한 복제는 사적 복제로 인정하지 않음.
    - '한정된 범위'에는 인적범위뿐 아니라 양적범위도 포함해서 해석:
      - 불필요하게 많은 양을 복제하는 것은 사적 이용으로 인정되지 않음. 일부만 복제해도 되는데 책 전체를 복제한 경우 한정된 범위로 인정하지 않는 것.
      - 공중 복사기기가 아니더라도 교과서를 처음부터 끝까지 복제하는 행위는 한정된 범위 안에서의 이용으로 보지 않아 사적이용을 위한 복제로 인정되지 않음.
- 영리를 목적으로 하지 아니하는 공표된 저작물의 공연, 방송:
  - e.g., 뮤지컬 보고 감명받아서 학교 축제에서 그 뮤지컬을 공연. 저작권 침해인가?
  - 무료로 공연하는 경우, 공연자가 반대 급부를 받지 않는 한 비영리목적의 공연에 해당하므로 저작권 침해가 성립하지 않음.
- 공연의 직접 대가로서 반대급부를 받지 않는 상업용 음반 등의 공연:
  - 음반이나 영상을 공중에게 재생함으로써 공연하는 경우 직접적 대가를 받지 않으면 저작권 침해의 예외가 인정됨.
  - 음반의 재생에 의한 공연으로 그 음반이 소비자들에게 알려짐으로써 저작권자가 간접적 이익을 얻게 된다는 점을 고려한 것.
  - e.g., 백화점에서 무단으로 노래를 틀음. 백화점은 고객들에게 음악에 대한 대가를 청구하지 않았으므로 저작권법상 예외에 해당한다고 주장.
    - 한정된 공간에서 음반을 송신했으므로 방송이 아니라 공연임.
    - 단, 유흥주점, 전문체육시설, 음악 및 영상 감상이 영업의 주요내용의 일부로 하는 공간, 여객용 항공기나 선박, 열차 등, 백화점 및 대형마트 등에서 하는 공연은 비영리 목적 공연권의 예외를 인정바을 수 없음.
- 프로그램에 관한 특례:
  - e.g., 윈도우즈용 프린터 드라이버가 내 OS와 호환되지 않아 역분석해 수정. 이때 기술적 보호조치를 해제하고, 역분석해서 얻은 호환정보를 커뮤니티에 공유했음. 저작권법 위반인가?
  - 컴퓨터 프로그램은 사상의 표현과 기능을 쉽게 구별할 수 없기 때문에 특칙을 규정.
  - > 저작권법 제101조의4(프로그램코드역분석)
    > - (1) 정당한 권한에 의하여 프로그램을 이용하는 자 또는 그의 허락을 받은 자는 호환에 필요한 정보를 쉽게 얻을 수 없고 그 획득이 불가피한 경우에는 해당 프로그램의 호환에 필요한 부분에 한정하여 프로그램의 저작재산권자의 허락을 받지 아니하고 프로그램코드역분석을 할 수 있다. <개정 2023. 8. 8.>
  ...
  - 다른 프로그램과의 호환목적을 위한 프로그램의 역분석을 허용.
  - 프로그램의 호환정보 획득을 위한 과정에서 기술적 보호조치를 회피한 행위도 위법으로 판단하지 않음.
- 컴퓨터 저작물 이용과정에서 발생한 일시적 복제:
  - 컴퓨터 저작물에 대해서는 일시적 복제에 대한 면책규정이 있음.
  - 통상적인 프로그램의 작동과정의 일부로서 발생하는 일시적 복제는 저작권 침해로 인정되지 않음.
  ...
  - 버퍼링이나 캐싱으로 인한 일시적 복제는 저작권 침해로 인정되지 않음.
  - 면책을 위한 요건:
    - 컴퓨터에서 저작물을 이용하는 경우
    - 원활하고 효율적인 정보처리를 위해 필요하다고 인정되는 범위에서
    - 컴퓨터를 이용한 저작물 이용행위 자체가 저작권 침해에 해당하지 않아야.
- 저작물의 공정이용:
  - 저작권 예외사항에 해당하지 않는다고 해도, 저작물의 통상적인 이용방법과 충돌하지 않고 저작권자의 정당한 이익을 침해하지 않는다면 저작물을 이용할 수 있다고 규정.
  - 미국의 공정사용(fair use) 조항을 도입한 것.
  - 공정이용 여부 판단 기준:
    - 사용의 목적: 목적이 영리적인지 비영리적인지
    - 저작물의 속성: 창작성이 높은지 낮은지
    - 권한없이 이용된 저작물의 비중: 전체가 이용되었는지 부분적 이용인지
    - 그 사용이 저작물의 가치 혹은 저작물의 잠재적 시장에 미치는 영향
  - 추가적으로, 저작권법 제35조의3(부수적 복제 등)에 따라 사진촬영, 녹음 또는 녹화 과정에서 보이거나 들리는 저작물이 촬영 등의 주된 대상에 부수적으로 포함된 경우 저작권자의 이익을 부당하게 해치지 않는 한, 이를 복제, 배포, 공연, 전시, 또는 공중송신할 수 있도록 허용.
- 기타 저작권 예외 사유:
  - 재판절차 등에서의 복제
  - 정치적 연설 공공저작물 등의 자유이용
  - 시사보도를 위한 이용
  - 시사적인 기사 및 논설의 복제
  - 공표된 저작물의 인용
  - 도서관 등에서의 복제
  ...
  - 미술저작물 등의 전시 또는 복제
  - 번역 등에 의한 이용
- 저작권법 예외규정에 의해 저작물을 이용하는 자가 예외를 인정받으려면 출처를 명시해야.

#### 저작인접권자의 권리

- 저작인접권자: 저작물을 직접 창작한 자는 아니지만, 저작물을 외부에 표현한 실연자, 음반제작자, 방송사업자.
- 실연자의 공연, 음반제작자의 고정음반, 방송사업자의 방송에 대한 권리로 제한.
- 실연자의 권리:
  - 저작인접권자의 복제권은 저작권자의 복제권보다 훨씬 제한적인 범위에서 인정.
  - 표현된 실연과 완전히 동일한 복제를 금지하는 권리에 한정. 제3자가 실연을 모방하는 것을 제한할 수는 없음. (저작유사권 침해 주장은 가능)
  - e.g., A가 만든 노래를 B가 실연. 방송에서 B의 노래를 C가 실연. C가 부른 노래를 녹음해서 블로그에 올림. 누구의 권리를 침해한 것인가?
    - 일단 실연자인 C의 허락없는 복제, 전송이 이뤄져 권리를 침해한 것이 됨.
    - 방송국이 제작한 방송 영상을 방송사업자 허락없이 녹화해 복제권을 침해한 것이 됨.
    - B는 자신의 실연에 대한 복제권만 가짐. 원저작물의 이용을 막을 권리는 없음.
- 저작인접권의 보호기간:
  - 실연은 실연한 때, 음반은 음을 음반에 고정한 때, 방송은 방송한 때부터 발생.
  - 실연과 음반은 50년, 방송은 70년.
...
- 상품이나 서비스의 출처표시를 보호.
- 소비자의 오인유발을 방지해 소비자의 올바른 선택을 보조하기 위한 것.
- 상표: 자기의 상품과 타인의 상품을 식별하기 위해 사용하는 표장
  - 상품의 출처를 나타내기 위해 사용하는 모든 표시가 상표가 될 수 있음.
  - KFC 흰옷 입은 할아버지(입체형상), 향수의 향(냄새상표)도 상표가 될 수 있음.
- 상호: 상법상 상인의 명칭. 상표는 상품이나 서비스의 명칭이므로 구분됨. 상호는 등기여부에 관계없이 상법상 일정한 보호대상. 상호가 기존 상표권을 침해할수도. 보통 상호를 상표 등록함.
- 상표권의 효력과 선출원주의:
  - 상표권을 보호받으려면 지정상품/서비스에 대한 상표를 등록해야.
  - 상표권 침해가 성립하려면 지정삼품/서비스가 동일하고 상표가 유사해야.
  - 다른 날 동일 유사 상표 출원한 경우: 먼저 출원된 상표만 상표등록이 가능.
  - 같은 날 동일 유사 상표 출원한 경우: 협의로 결정. 협의가 안 되면 추첨으로 결정.
-  상표권의 존속기간:
  - 상표권을 보호하는 이유는 소비자의 오인유발을 방지하는 것.
  - 상표건의 존속기간은 10년. 바로 소멸하지 않고 갱신할 수 있음.
- 상표의 등록요건:
  - > 상표법 제33조(상표등록의 요건)
    ...
    > - (2) 제1항제3호부터 제7호까지에 해당하는 상표라도 상표등록출원 전부터 그 상표를 사용한 결과 수요자 간에 특정인의 상품에 관한 출처를 표시하는 것으로 식별할 수 있게 된 경우에는 그 상표를 사용한 상품에 한정하여 상표등록을 받을 수 있다. <개정 2023. 10. 31.>
    > - (3) 제1항제3호(산지로 한정한다) 또는 제4호에 해당하는 표장이라도 그 표장이 특정 상품에 대한 지리적 표시인 경우에는 그 지리적 표시를 사용한 상품을 지정상품(제38조제1항에 따라 지정한 상품 및 제86조제1항에 따라 추가로 지정한 상품을 말한다. 이하 같다)으로 하여 지리적 표시 단체표장등록을 받을 수 있다.
  - 상표를 실제로 사용할 의사가 있어야 한다. (회피하려면 얼마든 한다.)
- 식별력없는 표장:
  - 상표는 식별력이 있어야.
  - 보통명칭이나 동업자들 사이에서 관용적으로 쓰이는 관용표장은 식별력없는 명칭.
  - 기술적 표장:
    - 상품의 원재료명을 그대로 사용하는 것은 식별력없음.
    - e.g., '알바천국'은 상표등록 인정되지만, '김밥천국'은 상표등록이 안 됨.
    - e.g., 스벅 '더블샷'은 상품의 품질과 효능을 직감할 수 있는 기술적 표장.
  - 현저한 지리적 표시:
    - e.g., '황해도 굴비'는 지리적 명칭이므로 상표등록이 안 됨.
    - e.g., '고기리 막국수'는 왜 등록되나? 고기리가 현행 지명이 아님. '고기동 막국수'면 안 됨.
    - 예외적으로 단체는 지리적 표시를 등록할 수 있음. 단, 실제 해당 지역에서 활동해야.
    - 전혀 듣도보도 못한 지명은 식별력이 있으므로 상표로 등록할 수 있음.
    - 증류주는 무조건 지리적 표시가 불가. 현저하지 않아도 등록불가.
  - 흔히 있는 성 또는 명칭: e.g., '고박사 냉면' 상표등록이 안 됨.
  - 사용에 의한 식별력: 상표 등록하지 않은 상태로 오랜 기간 계속사용함으로써 식별력을 획득한 경우 등록 가능해짐.
- 상표 불등록요건:
  - > 상표법 제34조(상표등록을 받을 수 없는 상표)
  - 조문이 엄청 길다. 몇 개만 보자.
  - 국가의 국기 및 국제기구의 기장과 동일 유사한 상표.
  - 저명한 고인과의 관계를 거짓으로 표시하거나 모욕, 평판을 나쁘게 할 우려가 있는 상표.
  - 저명한 타인의 성명 또는 초상 등을 포함한 상표. 단, 그 타인의 승낙을 받은 경우 등록 가능.
  - 도덕관념인 선량한 풍속에 어긋나는 등 공공의 질서를 해칠 우려가 있는 상표.
  - 선출원에 의한 타인의 상표와 동일, 유사한 상표로서 그 지정상품과 동일한 상품에 사용하는 상표.
  - 주지/저명상표와 동일, 유사한 상표:
    - 주지상표: 특정 수요자간에 현저하게 인식되어 있는 상표.
    - 저명상표: 주지의 정도를 넘어 거래자 외에 일반 공중의 대부분에게 인식되어 있는 상표.
    - 주지상표와 동일, 유사한 상표로서 그 지정상품과 동일한 상품에 사용하는 상표.
    - 저명상표는 그 지정상품과 동일하지 않더라도 무조건 등록불가.
  - 품질을 오인하게 하거나 수요자를 기만할 염력아 있는 상표.
  - 포도주나 증류주의 지리적 명칭.
- 상표침해의 면제:
  - > 상표법 제90조(상표권의 효력이 미치지 아니하는 범위)
  - 자기의 성명·명칭 또는 상호·초상·서명·인장 또는 저명한 아호·예명·필명과 이들의 저명한 약칭을 상거래 관행에 따라 사용하는 상표. (자기 이름을 쓰겠다는데 어떻게 막겠어)
  - 상품의 보통명칭, 산지, 품질, 효능, 용도 등을 보통으로 사용하는 방법으로 표시하는 상표.
  - 선사용에 의한 상표 계속 사용권:
    - > 상표법 제99조(선사용에 따른 상표를 계속 사용할 권리)
      > - (1) 타인의 등록상표와 동일·유사한 상표를 그 지정상품과 동일·유사한 상품에 사용하는 자로서 다음 각 호의 요건을 모두 갖춘 자(그 지위를 승계한 자를 포함한다)는 해당 상표를 그 사용하는 상품에 대하여 계속하여 사용할 권리를 가진다.
      ...
      > - (2) 자기의 성명·상호 등 인격의 동일성을 표시하는 수단을 상거래 관행에 따라 상표로 사용하는 자로서 제1항제1호의 요건을 갖춘 자는 해당 상표를 그 사용하는 상품에 대하여 계속 사용할 권리를 가진다.
      > - (3) 상표권자나 전용사용권자는 제1항에 따라 상표를 사용할 권리를 가지는 자에게 그 자의 상품과 자기의 상품 간에 출처의 오인이나 혼동을 방지하는 데 필요한 표시를 할 것을 청구할 수 있다.
      - 선출원 상표와 동일, 유사한 상표를 사용함에도 불구하고 선사용자의 항변권을 인정.
  - 전통적 공정사용: 선출원 상표를 구성하는 낱말을 사용하는 것에 불과한 경우.
  - 상표의 명목적 사용:
    - e.g., "윈도우즈98 길라잡이" 책을 출판. 마소에서 상표권 침해 주장.
    - e.g., 다음이 "야후는 다음이 물리치겠습니다" 광고. 야후가 상표권 침해 주장.
    - 그 상표를 지칭하기 위해 언급하는 경우 상표침해가 면책됨.
...
- 내가 강의 마칠 때마다 하는 얘기가 있는데. 내가 아주대 89학번입니다. 기회는 운입니다. 하지만 기회를 잡으려면 실력이 갖춰져 있어야 합니다. 꿈을 가지세요. 끝.
